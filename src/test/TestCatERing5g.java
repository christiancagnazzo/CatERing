...
public class TestCatERing5g {
    public static void main(String[] args) {
        try {
            ...
            CatERing.getInstance().getTaskManager().assignTask(turns.get(0),t1,"","2 porzioni");

            System.out.println("SHEET BEFORE");
            System.out.println(sheet);

            CatERing.getInstance().getTaskManager().setPortions(t1,"4 pezzi");
